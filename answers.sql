...
SELECT models.name, brand_name, headquarters                                                                                        FROM models, brands                                                                                                                        WHERE models.name='Mustang' AND brands.name='Ford';
...
SELECT models.name, brand_name, brands.founded FROM models
LEFT JOIN brands ON(models.brand_name=brands.name) WHERE models.year = 1960;
...
LEFT JOIN models AS m ON b.name=m.brand_name WHERE b.discontinued IS NULL;
...
SELECT m.name, m.brand_name, b.founded FROM models AS m LEFT JOIN brands AS b                                                       ON b.name=m.brand_name WHERE b.founded IS NOT NULL AND m.name IS NOT NULL;
...
SELECT b.name, founded FROM brands AS b LEFT JOIN models AS m ON b.name=m.brand_name WHERE m.year > 1940;SELECT b.name, founded FROM brands AS b LEFT JOIN models AS m ON b.name=m.brand_name WHERE b.founded > 1940 AND m.name IS NULL;
